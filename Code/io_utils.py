...
def read_patient_jsons(input_dir, limit=None, seed=42):
    """
    ...
    Args:
        ...
        limit (int): If limit is not None, returns a RANDOM sample of size=limit (reproducible via seed).
    ...
    for fp in files:
        ...
        gold[uid] = [str(k) for k, v in sp_dict.items() if v in (1, 2)]
